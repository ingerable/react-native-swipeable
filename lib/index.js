...
var Swipeable = function (_PureComponent) {
  ...
  function Swipeable() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Swipeable.__proto__ || Object.getPrototypeOf(Swipeable)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var angle = Math.abs(Math.atan2(gestureState.vx, gestureState.vy) * 180 / Math.PI);
      return Math.abs(gestureState.dx) > _this.props.swipeStartMinDistance && angle > 90 - _this.props.swipeAngle && angle < 90 + _this.props.swipeAngle;
...
Swipeable.propTypes = {
  ...
  swipeAngle: _propTypes.PropTypes.number,
